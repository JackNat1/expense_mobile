...
import { Plus, Download, Search, Filter, Trash2, Image as ImageIcon } from 'lucide-react';
            ...
            <div key={expense.id} className="bg-white p-4 rounded-xl border shadow-sm flex items-center space-x-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500 flex items-center justify-between">
                  <span>{format(parseISO(expense.date), 'MMM d, yyyy')} • {expense.customer || 'No Customer'}</span>
                  <button 
